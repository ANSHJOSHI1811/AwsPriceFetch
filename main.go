...
func main() {
	...
	db.AutoMigrate(&models.Provider{}, &models.Service{}, &models.Region{}, &models.SKU{}, &models.Price{}, &models.Term{}, &models.SavingPlan{})
		...
		service := models.Service{ServiceName: "AmazonEC2", ProviderID: provider.ProviderID}
		db.FirstOrCreate(&service, models.Service{ServiceName: "AmazonEC2"})
